...
if __name__ == "__main__":
    ...
    #https://docs.google.com/uc?export=download&id=1xTqFxguYxvF8zf7_e_clAq2GTq1Wi3vC
    ...
    #https://docs.google.com/uc?export=download&id=1LKHVBPeadPzbMZjsXyALD0ERMyayq1vv
